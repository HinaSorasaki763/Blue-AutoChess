...
public class Shiroko_Terror_SkillCTRL : MonoBehaviour
{
    ...
    public int Choose(SkillContext skillContext)
    {
        ...
        if (SpawnGrid.Instance.CountCharactersWithinRadius(centerNode, isAlly, 2, true, parent) >= 2)
        {
        ...
        if (SpawnGrid.Instance.CountCharactersWithinRadius(bestNode, isAlly, 2, true, parent) >= 3)
        {
